...
public interface LindaMethods extends Remote {
	 ...
	 */
	public void eventRegister(Tuple template, Callback callback) throws java.rmi.RemoteException;	
	
	/** To debug, prints any information it wants (e.g. the tuples in tuplespace or the registered callbacks), prefixed by <code>prefix</code. */
	public void debug(String prefix) throws java.rmi.RemoteException;

	/** To send the callback serialized to the server who will deserialize it */
	public void eventRegisterAux(Tuple template, byte[] cbBytes) throws java.rmi.RemoteException;
